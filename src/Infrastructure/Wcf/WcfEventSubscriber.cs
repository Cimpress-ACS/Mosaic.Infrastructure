...
{
    public abstract class WcfEventSubscriber<TServiceCallback>
    {
        protected readonly ISafeEventRaiser EventRaiser;

        public TServiceCallback Callback { get; private set; }
