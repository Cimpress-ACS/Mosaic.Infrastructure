...
{
    /// <summary>
    /// The implementer of <see cref="IProvideConfiguration"/> is capable of accessing the
    /// applications configuration and provide specific information from them.
    /// </summary>
    public interface IProvideConfiguration
    {
        ...
        /// <returns></returns>
        T GetConfiguration<T>(string section) where T: class;
    }
}
