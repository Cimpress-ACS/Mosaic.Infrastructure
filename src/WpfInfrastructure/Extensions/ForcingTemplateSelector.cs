...
{
    public class ForcingTemplateSelector : DataTemplateSelector
    {
        ...
        {
            var forcingValueKeyViewModel = (ForcingKeyValueUnitViewModel) item;

            if (forcingValueKeyViewModel.Value is bool) return BoolTemplate;
